...
INSERT INTO `school`.`exercise` (`id`, `title`, `description`) 
...
c)  Z jaką prędkością poruszał się samochód osobowy w chwili, gdy mijał samochód ciężarowy?');
...
VALUES ('5', 'Ludożercy i misjonarze', 'Trzech misjonarzy podróżuje po Afryce w towarzystwie trzech ludożerców. Ludożercy oczywiście już nie są ludożercami, ale przestali nimi być stosunkowa niedawno.
     ...
     Do rozwiązywania najlepiej jest używać zapałek. Trzy zapałki z główkami - to misjonarze, dwie połówki bez główek - to ludożercy i wreszcie połówka z główką - wiosłujący ludożerca.');
...
VALUES ('6', 'Jak podzielić?', 'Pewien ojciec sześciu synów dał z okazji Nowego Roku najstarszemu synowi 60 zł i rzekł:
     ...
     Pytanie: W jaki sposób najstarszy syn rozdzielił powyższą sumę, by wypełnić dokładnie życzenie ojca, a nie dokonywać trudnych rachunków?');
...
INSERT INTO `school`.`exercise` (`id`, `title`, `description`) 
VALUES ('7', 'Pogrzeb', 'Historia pewnej dziewczyny. Na pogrzebie swojej matki spotyka chłopaka którego nigdy
...
Podpowiedź znajdziesz poniżej. Zanim zajrzysz pomyśl...');
